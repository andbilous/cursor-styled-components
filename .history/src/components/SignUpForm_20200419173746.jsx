...
class SignUpForm extends React.Component{
  ...
  <div class="login-page">
    ...
    <div class="form">
      ...
      <input type="text" value={this.state.lastName} placeholder="Last Name"/></div>
      <input type="text" value={this.state.email} placeholder="Email-address"/>
        <input type="password" value={this.state.firstName} placeholder="password"/>
